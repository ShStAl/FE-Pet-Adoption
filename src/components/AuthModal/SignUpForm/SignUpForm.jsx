  ...
  return (
    <>
      <div className="flex flex-col text-xl space-y-3">
        ...
        <div>
          <label className="block text-base text-gray-500">Confirm Password</label>

          <div className="relative flex items-center mt-2">
            <button onClick={() => setShowPasswordC((prev) => !prev)} className="absolute right-0 focus:outline-none rtl:left-0 rtl:right-auto">
              {!showPasswordC ? (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mx-4 text-gray-400 transition-colors duration-300 hover:text-gray-500">
                  <path d="M15.5 12a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" />
                  <path d="M12 3.5c3.432 0 6.124 1.534 8.054 3.241 1.926 1.703 3.132 3.61 3.616 4.46a1.6 1.6 0 0 1 0 1.598c-.484.85-1.69 2.757-3.616 4.461-1.929 1.706-4.622 3.24-8.054 3.24-3.432 0-6.124-1.534-8.054-3.24C2.02 15.558.814 13.65.33 12.8a1.6 1.6 0 0 1 0-1.598c.484-.85 1.69-2.757 3.616-4.462C5.875 5.034 8.568 3.5 12 3.5ZM1.633 11.945a.115.115 0 0 0-.017.055c.001.02.006.039.017.056.441.774 1.551 2.527 3.307 4.08C6.691 17.685 9.045 19 12 19c2.955 0 5.31-1.315 7.06-2.864 1.756-1.553 2.866-3.306 3.307-4.08a.111.111 0 0 0 .017-.056.111.111 0 0 0-.017-.056c-.441-.773-1.551-2.527-3.307-4.08C17.309 6.315 14.955 5 12 5 9.045 5 6.69 6.314 4.94 7.865c-1.756 1.552-2.866 3.306-3.307 4.08Z" />
        ...
        <div>
          <label className="block text-base text-gray-500">First Name</label>

          <div className="relative flex items-center mt-2">
            <span className="absolute">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 30 30" strokeWidth="0" stroke="currentColor" className="w-6 h-6 mx-3 mt-1 text-gray-400"><path d="M12 2.5a5.5 5.5 0 0 1 3.096 10.047 9.005 9.005 0 0 1 5.9 8.181.75.75 0 1 1-1.499.044 7.5 7.5 0 0 0-14.993 0 .75.75 0 0 1-1.5-.045 9.005 9.005 0 0 1 5.9-8.18A5.5 5.5 0 0 1 12 2.5ZM8 8a4 4 0 1 0 8 0 4 4 0 0 0-8 0Z" /></svg>
            </span>
        ...
        <div>
          <label className="block text-base text-gray-500">Last Name</label>
        ...
        <div className="mb-3">
          <label className="block text-base text-gray-500">Phone Number</label>

          <div className="relative flex items-center mt-2">
            <span className="absolute">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 30 30" strokeWidth="0" stroke="currentColor" className="w-6 h-6 mx-3 mt-1 text-gray-400">
